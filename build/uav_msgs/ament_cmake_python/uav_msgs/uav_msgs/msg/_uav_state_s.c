...
bool uav_msgs__msg__uav_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uav_msgs.msg._uav_state.UavState", full_classname_dest, 32) == 0);
  }
  uav_msgs__msg__UavState * ros_message = _ros_message;
  {  // x
...
PyObject * uav_msgs__msg__uav_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uav_msgs.msg._uav_state");
