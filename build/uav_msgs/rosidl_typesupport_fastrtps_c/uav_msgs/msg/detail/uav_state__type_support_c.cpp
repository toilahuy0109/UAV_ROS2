...
#include "uav_msgs/msg/detail/uav_state__rosidl_typesupport_fastrtps_c.h"
...
using _UavState__ros_msg_type = uav_msgs__msg__UavState;
...
size_t get_serialized_size_uav_msgs__msg__UavState(
  const void * untyped_ros_message,
...
static uint32_t _UavState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uav_msgs__msg__UavState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_uav_msgs
size_t max_serialized_size_uav_msgs__msg__UavState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uav_msgs__msg__UavState;
    is_plain =
      (
...
static size_t _UavState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uav_msgs__msg__UavState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uav_msgs, msg, UavState)() {
